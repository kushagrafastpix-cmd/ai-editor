...
import SpeechEnhancementImage from "@/assets/SpeechEnhancementImage.png";

interface SpeechEnhancementProps {
  onBack: () => void;
}

const SpeechEnhancement = ({ onBack }: SpeechEnhancementProps) => {
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide">
        <div className="flex flex-col px-4 py-4">
          ...
          {/* Enable speech enhancement control */}
          <div className="flex items-center justify-between gap-6">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-gray-500">
                Improve vocal clarity and richness.
              </span>
            </div>
