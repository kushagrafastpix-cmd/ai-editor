!function() {
    try {
        ...
        e._sentryDebugIds[t] = "ab8560f9-6e5d-4b00-84e9-3ca555f8eb58",
        e._sentryDebugIdIdentifier = "sentry-dbid-ab8560f9-6e5d-4b00-84e9-3ca555f8eb58")
    } catch (e) {}
}(),
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[388], {
    4736: function(e) {
        ...
        t = () => ( () => {
            "use strict";
            var e, t, n, r, i, a, o, s, u, l, c, h, d, f, p, v, m, b, g, y, w, _, C, A, R, E, M, P, T, I, L, k, F, S, O, x, j, D, B, U, W, V, N, $, H, z, Y, X, G, q, J, K, Z, Q, ee, et, en = [, (e, t, n) => {
                var r;
                n.r(t),
                n.d(t, {
                    default: () => i
                });
                let i = (r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0,
                function(e={}) {
                    function t() {
                        function e(e) {
                            let a = r;
                    ...
                    let a = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" ")
                      , o = new function() {
                            ...
                            if (!t) {
                                ...
                                if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                                    ...
                                    !u)
                                        ...
                                        !1
                                } else if (u = e.getContext("webgl2", n))
                                    r = 2;
                                else {
                                    if (!(u = e.getContext("webgl", n)))
                                        return console.log("No WebGL support. Image mesh will not be drawn."),
                                ...
                                if (i = Math.min((u = new Proxy(u,{
                                    get: (e, t) => e.isContextLost() ? (l || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", t),
                                    l = !0),
                                    ...
                                    set(e, t, n) {
                                        if (!e.isContextLost())
                                            return e[t] = n,
                                            !0;
                                        l || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + t),
                                        l = !0)
                                    }
                                })).getParameter(u.MAX_RENDERBUFFER_SIZE), u.getParameter(u.MAX_TEXTURE_SIZE)),
                                s(e = u.createProgram(), u.VERTEX_SHADER, "attribute vec2 vertex;\n                attribute vec2 uv;\n                uniform vec4 mat;\n                uniform vec2 translate;\n                varying vec2 st;\n                void main() {\n                    st = uv;\n                    gl_Position = vec4(mat2(mat) * vertex + translate, 0, 1);\n                }"),
                                s(e, u.FRAGMENT_SHADER, "precision highp float;\n                uniform sampler2D image;\n                varying vec2 st;\n                void main() {\n                    gl_FragColor = texture2D(image, st);\n                }"),
                                u.bindAttribLocation(e, 0, "vertex"),
                                u.bindAttribLocation(e, 1, "uv"),
                                u.linkProgram(e),
                                0 < ((n = u.getProgramInfoLog(e)) || "").trim().length)
                                    throw n;
                        ...
                        this.Lb = function(n) {
                            ...
                            2 == r ? (t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR_MIPMAP_LINEAR),
                        ...
                        this.Qb = function(n, r, i, l, p) {
                            if (e()) {
                                ...
                                if (t.canvas) {
                                    ...
                                    v = d.push(l),
                                    s != v && (t.bufferData(t.ARRAY_BUFFER, 8 * v, t.DYNAMIC_DRAW),
                                    s = v),
                                    v = 0,
                                    i))
                                        t.bufferSubData(t.ARRAY_BUFFER, v, b.Ta),
                                        v += 4 * b.Ta.length;
                                    for (var g of (console.assert(v == 4 * l),
                                    i))
                                        t.bufferSubData(t.ARRAY_BUFFER, v, g.Db),
                                        v += 4 * g.Db.length;
                                    for (var y of (console.assert(v == 8 * l),
                                    v = f.push(p),
                                    u != v && (t.bufferData(t.ELEMENT_ARRAY_BUFFER, 2 * v, t.DYNAMIC_DRAW),
                                    u = v),
                                    b = 0,
                                    i))
                                    ...
                                    v = b = 0,
                                    i)) {
                                        e.image.Ka != y && (t.bindTexture(t.TEXTURE_2D, e.image.Ja || null),
                                        y = e.image.Ka),
                                        e.mc ? (t.scissor(e.Ya, m - e.Za - e.jb, e.Ac, e.jb),
                                        g = !0) : g && (t.scissor(0, m - r, n, r),
                                        g = !1),
                                        i = 2 / n;
                                        let s = -2 / r;
                                        t.uniform4f(a, e.ha[0] * i * e.Ba, e.ha[1] * s * e.Ca, e.ha[2] * i * e.Ba, e.ha[3] * s * e.Ca),
                                        t.uniform2f(o, e.ha[4] * i * e.Ba + i * (e.Ya - e.ic * e.Ba) - 1, e.ha[5] * s * e.Ca + s * (e.Za - e.jc * e.Ca) + 1),
                                        t.vertexAttribPointer(0, 2, t.FLOAT, !1, 0, v),
                                        t.vertexAttribPointer(1, 2, t.FLOAT, !1, 0, v + 4 * l),
                                        t.drawElements(t.TRIANGLES, e.indices.length, t.UNSIGNED_SHORT, b),
                                        v += 4 * e.Ta.length,
                                        b += 2 * e.indices.length
                                    }
                                    console.assert(v == 4 * l),
                    ...
                    e.onRuntimeInitialized = function() {
                        ...
                        function i() {
                            for (let e of (0 < R.length && (o.Qb(A.drawWidth(), A.drawHeight(), R, E, M),
                            R = [],
                            M = E = 0,
                            A.reset(512, 512)),
                            C)) {
                        ...
                        var y = e.RenderImage.extend("CanvasRenderImage", {
                          ...
                          , _ = c.extend("CanvasRenderPaint", {
                            ...
                            draw: function(e, t, n) {
                                ...
                                var a = this.Xa
                                  , o = this.ja;
                                if (e.globalCompositeOperation = this.Eb,
                                null != o) {
                                    a = o.yb;
                                    var s = o.zb;
                                    let t = o.bb;
                                    ...
                                    o.ec ? (o = t - a,
                                    u -= s,
                                    a = e.createRadialGradient(a, s, 0, a, s, Math.sqrt(o * o + u * u))) : a = e.createLinearGradient(a, s, t, u);
                                    for (let e = 0, t = n.length; e < t; e++)
                                        s = n[e],
                                        a.addColorStop(s.stop, r(s.color));
                                    this.Xa = a,
                                    this.ja = null
                                }
                                switch (i) {
                        ...
                        var P = e.CanvasRenderer = h.extend("Renderer", {
                            ...
                            transform: function(e, t, n, r, i, a) {
                                ...
                                this.H.push(this.C.transform.bind(this.C, e, t, n, r, i, a))
                            },
                            rotate: function(e) {
                                let t = Math.sin(e);
                                e = Math.cos(e),
                            ...
                            _drawPath: function(e, t) {
                                this.H.push(t.draw.bind(t, this.C, e.T, e.Va === b ? "evenodd" : "nonzero"))
                            },
                            ...
                            _drawImageMesh: function(t, r, a, s, u, l, c, h, d, f) {
                                var p = this.C.canvas.width
                                  , v = this.C.canvas.height;
                                let m = d - c
                                  , b = f - h;
                                c = Math.max(c, 0),
                                h = Math.max(h, 0);
                                let g = (d = Math.min(d, p)) - c
                                  , y = (f = Math.min(f, v)) - h;
                                if (console.assert(g <= Math.min(m, p)),
                                console.assert(y <= Math.min(b, v)),
                                !(0 >= g || 0 >= y)) {
                                    d = g < m || y < b,
                                    p = f = 1;
                                    var w = Math.ceil(g * f)
                                    ...
                                    _ > v && (p *= v / _,
                                    _ = v),
                                    A || (A = new e.DynamicRectanizer(v)).reset(512, 512),
                                    0 > (v = A.addRect(w, _)) && (i(),
                                    C.add(this),
                                    console.assert(0 <= (v = A.addRect(w, _))));
                                    var P = 65535 & v
                                      , T = v >> 16;
                                    R.push({
                            ...
                            _clipPath: function(e) {
                                this.H.push(this.C.clip.bind(this.C, e.T, e.Va === b ? "evenodd" : "nonzero"))
                            },
                            clear: function() {
                                C.add(this),
                        ...
                        ,
                        u = new t,
                        e.requestAnimationFrame = u.requestAnimationFrame.bind(u),
                    ...
                    ;
                    var u, l, c, h, d, f, p, v, m, b = Object.assign({}, e), g = "./this.program", y = "object" == typeof window, w = "function" == typeof importScripts, _ = "";
                    (y || w) && (w ? _ = self.location.href : "undefined" != typeof document && document.currentScript && (_ = document.currentScript.src),
                    r && (_ = r),
                    ...
                    var C = e.print || console.log.bind(console)
                      , A = e.printErr || console.error.bind(console);
                    Object.assign(e, b),
                    b = null,
                    ...
                    function j() {
                        ...
                        e.HEAPU32 = F = new Uint32Array(t),
                        e.HEAPF32 = S = new Float32Array(t),
                        e.HEAPF64 = O = new Float64Array(t)
                    }
                    var D, B = [], U = [], W = [], V = 0, N = null, $ = null;
                    function H(t) {
                    ...
                    var q, J, K, Z = {
                        ...
                        452085: (e, t, n, r, i, a) => {
                            ...
                            var o = {}
                              , s = {};
                            return e == window.h.I.ya && 0 != n && (s.sampleRate = n),
                            ...
                            o.Z.onaudioprocess = function(n) {
                                if ((null == o.sa || 0 == o.sa.length) && (o.sa = new Float32Array(S.buffer,i,r * t)),
                                e == window.h.I.capture || e == window.h.I.La) {
                                    for (var s = 0; s < t; s += 1)
                                        for (var u = n.inputBuffer.getChannelData(s), l = o.sa, c = 0; c < r; c += 1)
                                            l[c * t + s] = u[c];
                                    nh(a, r, i)
                                }
                        ...
                        455035: e => {
                            void 0 !== (e = window.h.ra(e)).Z && (e.Z.onaudioprocess = function() {}
                            ,
                            e.Z.disconnect(),
                            e.Z = void 0),
                            void 0 !== e.Da && (e.Da.disconnect(),
                            e.Da = void 0),
                            e.J.close(),
                            e.J = void 0,
                            e.pb = void 0
                    ...
                    function eo() {
                        ...
                        return e = ee(e.split("/").filter(e => !!e), !t).join("/"),
                        (t ? "/" : "") + e || "."
                    }
                    ...
                    var eb, eg, ey, ew, e_ = {
                        ...
                        createNode(e, t, n, r) {
                            ...
                            16384 == (61440 & (n = eO(e, t, n, r)).mode) ? (n.l = e_.O.dir.node,
                            n.m = e_.O.dir.stream,
                            n.j = {}) : 32768 == (61440 & n.mode) ? (n.l = e_.O.file.node,
                            n.m = e_.O.file.stream,
                            n.v = 0,
                            n.j = null) : 40960 == (61440 & n.mode) ? (n.l = e_.O.link.node,
                            n.m = e_.O.link.stream) : 8192 == (61440 & n.mode) && (n.l = e_.O.$a.node,
                            n.m = e_.O.$a.stream),
                        ...
                        l: {
                            Y(e) {
                                var t = {};
                                return t.Jc = 8192 == (61440 & e.mode) ? e.id : 1,
                                t.Mc = e.id,
                                t.mode = e.mode,
                                t.Oc = 1,
                                t.uid = 0,
                            ...
                            sb(e) {
                                var t, n = [".", ".."];
                                for (t in e.j)
                                    e.j.hasOwnProperty(t) && n.push(t);
                                return n
                            },
                            Ea: (e, t, n) => ((e = e_.createNode(e, t, 41471, 0)).link = n,
                            e),
                            ma(e) {
                        ...
                        m: {
                            ...
                            write(e, t, n, r, i, a) {
                                if (t.buffer === P.buffer && (a = !1),
                                !r)
                                    return 0;
                                if ((e = e.node).timestamp = Date.now(),
                                t.subarray && (!e.j || e.j.subarray)) {
                                    if (a)
                                        return e.j = t.subarray(n, n + r),
                                        e.v = r;
                                    if (0 === e.v && 0 === i)
                                        return e.j = t.slice(n, n + r),
                                        e.v = r;
                                    if (i + r <= e.v)
                                        return e.j.set(t.subarray(n, n + r), i),
                                        r
                                }
                                if (em(e, i + r),
                            ...
                            nb: (e, t, n, r) => (e_.m.write(e, t, 0, r, n, !1),
                            0)
                        }
                    }, eC = null, eA = {}, eR = [], eE = 1, eM = null, eP = !0, eT = null, eI = {}, eL = (e, t={}) => {
                        if (!(e = eo(e)))
                            return {
                                path: "",
                                node: null
                        ...
                        for (var n = eC, r = "/", i = 0; i < e.length; i++) {
                            var a = i === e.length - 1;
                            if (a && t.parent)
                                break;
                            if (n = eS(n, e[i]),
                    ...
                    , eS = (e, t) => {
                        var n;
                        if (n = (n = ej(e, "x")) ? n : e.l.ka ? 0 : 2)
                            throw new eT(n,e);
                        for (n = eM[eF(e.id, t)]; n; n = n.lc) {
                            var r = n.name;
                    ...
                    , eO = (e, t, n, r) => (t = eF((e = new ni(e,t,n,r)).parent.id, e.name),
                    e.lc = eM[t],
                    eM[t] = e), ex = e => {
                        var t = ["r", "w", "rw"][3 & e];
                        return 512 & e && (t += "w"),
                    ...
                    , ej = (e, t) => eP ? 0 : t.includes("r") && !(292 & e.mode) ? 2 : t.includes("w") && !(146 & e.mode) || t.includes("x") && !(73 & e.mode) ? 2 : 0, eD = (e, t) => {
                        try {
                            return eS(e, t),
                            20
                        } catch (e) {}
                    ...
                    , eX = e => {
                        ...
                        if (!e.l.ma)
                            throw new eT(28);
                        return eo(ek(e.parent), e.l.ma(e))
                    }
                    , eG = (t, n, r) => {
                        if ("" === t)
                            throw new eT(44);
                        ...
                        65536 & n && 16384 != (61440 & a.mode))
                            throw new eT(54);
                        if (!i && (r = a ? 40960 == (61440 & a.mode) ? 32 : 16384 == (61440 & a.mode) && ("r" !== ex(n) || 512 & n) ? 31 : ej(a, ex(n)) : 44))
                            throw new eT(r);
                        if (512 & n && !i) {
                            if (!(r = "string" == typeof (r = a) ? eL(r, {
                                fb: !0
                            }).node : r).l.P)
                                throw new eT(63);
                    ...
                    var e8 = e => (e || e5("Cannot use deleted val. handle = " + e),
                    e6.get(e).value)
                      , e9 = e => {
                        switch (e) {
                        case void 0:
                    ...
                    var ta = void 0
                      , to = {};
                    function ts(e, t) {
                        for (void 0 === t && e5("ptr should not be undefined"); e.A; )
                            t = e.na(t),
                            e = e.A;
                        return t
                    }
                    ...
                    function tc(e, t) {
                        var n = tu[e];
                        return void 0 === n && e5(t + " has unknown type " + tl(e)),
                        n
                    }
                    function th() {}
                    var td = !1;
                    ...
                    function tb(e, t) {
                        return t.u && t.o || tm("makeClassHandle requires ptr and ptrType"),
                        !!t.L != !!t.G && tm("Both smartPtrType and smartPtr must be specified"),
                        t.count = {
                            value: 1
                        },
                        tg(Object.create(e, {
                    ...
                    function tg(e) {
                        return "undefined" == typeof FinalizationRegistry ? (tg = e => e,
                        e) : (td = new FinalizationRegistry(e => {
                            tf(e.g)
                        }
                        ),
                        tg = e => {
                            var t = e.g;
                            return t.G && td.register(e, {
                                g: t
                            }, e),
                            e
                        }
                    ...
                    function tR(e, t, n) {
                        function r(t) {
                            (t = n(t)).length !== e.length && tm("Mismatched type converter count");
                        ...
                        var i = Array(t.length)
                          ...
                          , o = 0;
                        t.forEach( (e, t) => {
                            tu.hasOwnProperty(e) ? i[t] = tu[e] : (a.push(e),
                            tC.hasOwnProperty(e) || (tC[e] = []),
                            tC[e].push( () => {
                                i[t] = tu[e],
                                ++o === a.length && r(i)
                            }
                    ...
                    function tM(e, t, n={}) {
                        ...
                        !function(e, t, n={}) {
                            var r = t.name;
                            if (e || e5(`type "${r}" must have a positive integer typeid pointer`),
                            tu.hasOwnProperty(e)) {
                                if (n.$b)
                                    return;
                    ...
                    function tI(e, t, n) {
                        if (void 0 === e[t].B) {
                            var r = e[t];
                            e[t] = function() {
                                return e[t].B.hasOwnProperty(arguments.length) || e5(`Function '${n}' called with an invalid number of arguments (${arguments.length}) - expects one of (${e[t].B})!`),
                    ...
                    function tL(t, n, r) {
                        e.hasOwnProperty(t) ? ((void 0 === r || void 0 !== e[t].B && void 0 !== e[t].B[r]) && e5(`Cannot register public name '${t}' twice`),
                        tI(e, t, t),
                        e.hasOwnProperty(r) && e5(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`),
                        e[t].B[r] = n) : (e[t] = n,
                        void 0 !== r && (e[t].Pc = r))
                    }
                    ...
                    function tF(e, t, n) {
                        for (; t !== n; )
                            t.na || e5(`Expected null or instance of ${n.name}, got an instance of ${t.name}`),
                            e = t.na(e),
                            t = t.A;
                        return e
                    }
                    function tS(e, t) {
                        return null === t ? (this.Na && e5(`null is not a valid ${this.name}`),
                        0) : (t.g || e5(`Cannot pass "${tG(t)}" as a ${this.name}`),
                        t.g.o || e5(`Cannot pass deleted object as a pointer of type ${this.name}`),
                        tF(t.g.o, t.g.u.i, this.i))
                    }
                    function tO(e, t) {
                        if (null === t) {
                            if (this.Na && e5(`null is not a valid ${this.name}`),
                            this.ua) {
                                var n = this.Pa();
                                return null !== e && e.push(this.W, n),
                                n
                            }
                            return 0
                        }
                        if (t.g || e5(`Cannot pass "${tG(t)}" as a ${this.name}`),
                        t.g.o || e5(`Cannot pass deleted object as a pointer of type ${this.name}`),
                        !this.ta && t.g.u.ta && e5(`Cannot convert argument of type ${t.g.L ? t.g.L.name : t.g.u.name} to parameter type ${this.name}`),
                        n = tF(t.g.o, t.g.u.i, this.i),
                        this.ua)
                            switch (void 0 === t.g.G && e5("Passing raw pointer to smart pointer is illegal"),
                            this.tc) {
                            case 0:
                                t.g.L === this ? n = t.g.G : e5(`Cannot convert argument of type ${t.g.L ? t.g.L.name : t.g.u.name} to parameter type ${this.name}`);
                                break;
                            case 1:
                                n = t.g.G;
                                break;
                    ...
                    function tx(e, t) {
                        ...
                        0) : (t.g || e5(`Cannot pass "${tG(t)}" as a ${this.name}`),
                        t.g.o || e5(`Cannot pass deleted object as a pointer of type ${this.name}`),
                        t.g.u.ta && e5(`Cannot convert argument of type ${t.g.u.name} to parameter type ${this.name}`),
                        tF(t.g.o, t.g.u.i, this.i))
                    }
                    function tj(e, t, n, r) {
                        this.name = e,
                        ...
                        void 0 !== t.A ? this.toWireType = tO : (this.toWireType = r ? tS : tx,
                        this.K = null)
                    }
                    function tD(t, n, r) {
                        e.hasOwnProperty(t) || tm("Replacing nonexistant public symbol"),
                        void 0 !== e[t].B && void 0 !== r ? e[t].B[r] = n : (e[t] = n,
                        e[t].ea = r)
                    }
                    var tB = []
                      , tU = e => {
                        var t = tB[e];
                        return t || (e >= tB.length && (tB.length = e + 1),
                        tB[e] = t = D.get(e)),
                        t
                    }
                      , tW = (t, n) => {
                    ...
                    ;
                    function tV(e, t) {
                        var n = (e = tn(e)).includes("j") ? tW(e, t) : tU(t);
                        return "function" != typeof n && e5(`unknown function pointer with signature ${e}: ${t}`),
                        n
                    }
                    var tN = void 0;
                    function t$(e, t) {
                        ...
                        throw t.forEach(function e(t) {
                            r[t] || tu[t] || (tA[t] ? tA[t].forEach(e) : (n.push(t),
                            r[t] = !0))
                        }),
                    ...
                    function tH(e, t, n, r, i) {
                        var a = t.length;
                        2 > a && e5("argTypes array size mismatch! Must at least get return value and 'this' types!");
                        ...
                        var u = "void" !== t[0].name
                          ...
                          , d = [];
                        return function() {
                            if (arguments.length !== l && e5(`function ${e} called with ${arguments.length} arguments, expected ${l} args!`),
                            d.length = 0,
                            h.length = o ? 2 : 1,
                            h[0] = i,
                            o) {
                            ...
                            for (var a = 0; a < l; ++a)
                                c[a] = t[a + 2].toWireType(d, arguments[a]),
                                h.push(c[a]);
                            if (a = r.apply(null, h),
                            s)
                                tw(d);
                    ...
                    function tY(e, t, n) {
                        return e instanceof Object || e5(`${n} with invalid "this": ${e}`),
                        e instanceof t.i.constructor || e5(`${n} incompatible with "this" of type ${e.constructor.name}`),
                        e.g.o || e5(`cannot call emscripten binding method ${n} on deleted object`),
                        tF(e.g.o, e.g.u.i, t.i)
                    }
                    function tX(e) {
                    ...
                    var tq = "undefined" != typeof TextDecoder ? new TextDecoder("utf-16le") : void 0
                      , tJ = (e, t) => {
                    ...
                    , ne = e => 0 == e % 4 && (0 != e % 100 || 0 == e % 400), nt = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], nn = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], nr = (e, t, n, r) => {
                        function i(e, t, n) {
                        ...
                        for (c in l = {
                            ...
                            "%G": e => u(e),
                            "%H": e => a(e.Fa, 2),
                            "%I": e => (0 == (e = e.Fa) ? e = 12 : 12 < e && (e -= 12),
                            a(e, 2)),
                            "%j": e => {
                                for (var t = 0, n = 0; n <= e.Ga - 1; t += (ne(e.da + 1900) ? nt : nn)[n++])
                                    ;
                                return a(e.Sa + t, 3)
                            }
                            ,
                            ...
                            "%V": e => {
                                ...
                                if (2 >= (e.R + 371 - e.ca - 2) % 7 && t++,
                                t)
                                    53 == t && (4 == (n = (e.R + 371 - e.ca) % 7) || 3 == n && ne(e.da) || (t = 1));
                                else {
                                    t = 52;
                        ...
                        return (c = ed(n = n.replace(/\0\0/g, "%"), !1)).length > t ? 0 : (P.set(c, e),
                        c.length - 1)
                    }
                    ;
                    function ni(e, t, n, r) {
                    ...
                    ep(1280, {
                        ...
                        Oa: function(e, t) {
                            null === t || 10 === t ? (C(eu(e.F, 0)),
                            e.F = []) : 0 != t && e.F.push(t)
                        },
                        qa: function(e) {
                            e.F && 0 < e.F.length && (C(eu(e.F, 0)),
                            e.F = [])
                        },
                        bc: function() {
                            return {
                    ...
                    ep(1536, {
                        Oa: function(e, t) {
                            null === t || 10 === t ? (A(eu(e.F, 0)),
                            e.F = []) : 0 != t && e.F.push(t)
                        },
                        qa: function(e) {
                            e.F && 0 < e.F.length && (A(eu(e.F, 0)),
                            e.F = [])
                        }
                    }),
                    ez("/dev/tty", 1280),
                    ...
                    l = 0,
                    eK("random", c = () => (0 === l && (l = ea(u).byteLength),
                    u[--l])),
                    eK("urandom", c),
                    eH("/dev/shm", 16895, 0),
                    ...
                    e3 = e.BindingError = class extends Error {
                        constructor(e) {
                            super(e),
                    ...
                    e.getLiveInheritedInstances = function() {
                        var e, t = [];
                        for (e in to)
                            to.hasOwnProperty(e) && t.push(to[e]);
                        return t
                    }
                    ,
                    ...
                    ,
                    tv = e.InternalError = class extends Error {
                        constructor(e) {
                            super(e),
                    ...
                    tT.prototype.delete = function() {
                        this.g.o || tP(this),
                        this.g.fa && !this.g.ia && e5("Object already scheduled for deletion"),
                        th(this),
                        tf(this.g),
                    ...
                    ,
                    tj.prototype.Vb = function(e) {
                        return this.rb && (e = this.rb(e)),
                        e
                    }
                    ,
                    tj.prototype.ab = function(e) {
                        this.W && this.W(e)
                    }
                    ,
                    tj.prototype.argPackAdvance = 8,
                    tj.prototype.readValueFromPointer = t_,
                    tj.prototype.deleteObject = function(e) {
                        null !== e && e.delete()
                    }
                    ,
                    tj.prototype.fromWireType = function(e) {
                        function t() {
                            return this.ua ? tb(this.i.N, {
                                u: this.nc,
                                o: n,
                                L: this,
                                G: e
                        ...
                        if (void 0 !== r)
                            ...
                            this.ab(e),
                            r);
                        if (!(r = tp[r = this.i.Ub(n)]))
                            return t.call(this);
                        r = this.ta ? r.Kb : r.pointerType;
                        var i = function e(t, n, r) {
                            return n === r ? t : void 0 === r.A ? null : null === (t = e(t, n, r.A)) ? null : r.Pb(t)
                        }(n, this.i, r.i);
                        return null === i ? t.call(this) : this.ua ? tb(r.i.N, {
                            u: r,
                            o: i,
                            L: this,
                            G: e
                    ...
                    var ns = {
                        __syscall_fcntl64: function(e, t, n) {
                            ...
                            try {
                                ...
                                if (void 0 === eZ || "ErrnoError" !== e.name)
                                    throw e;
                                return -e.aa
                            }
                        },
                        ...
                        _embind_create_inheriting_constructor: function(e, t, n) {
                            ...
                            for (var u in e = e2(e, function() {
                                i.A.qb.forEach((function(e) {
                                    if (this[e] === o[e])
                                        throw new te(`Pure virtual function ${e} must be implemented in JavaScript`)
                                }
                                ).bind(this)),
                            ...
                            a.__construct = function() {
                                ...
                                tg(this),
                                e = ts(i, e = t.o),
                                to.hasOwnProperty(e) ? e5(`Tried to register registered instance: ${e}`) : to[e] = this
                            }
                            ,
                            a.__destruct = function() {
                                ...
                                var e = this.g.o;
                                e = ts(i, e),
                                to.hasOwnProperty(e) ? delete to[e] : e5(`Tried to unregister unregistered instance: ${e}`)
                            }
                            ,
                        ...
                        _embind_register_class: function(e, t, n, r, i, a, o, s, u, l, c, h, d) {
                            c = tn(c),
                            a = tV(i, a),
                            s && (s = tV(o, s)),
                            l && (l = tV(u, l)),
                                ...
                                var o = Object.create(i, {
                                    constructor: {
                                        value: t = e2(f, function() {
                                            ...
                                            if (void 0 === e)
                                                throw new e3(`Tried to invoke ctor of ${c} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(u.$).toString()}) parameters instead!`);
                                            return e.apply(this, arguments)
                                        })
                                    }
                                });
                                t.prototype = o;
                                var u = new tk(c,t,o,d,n,a,s,l);
                                u.A && (void 0 === u.A.oa && (u.A.oa = []),
                                u.A.oa.push(u)),
                                n = new tj(c,u,!0,!1),
                                i = new tj(c + "*",u,!1,!1);
                                var h = new tj(c + " const*",u,!1,!0);
                                return tp[e] = {
                                    pointerType: i,
                                    Kb: h
                                },
                        ...
                        _embind_register_class_class_function: function(e, t, n, r, i, a, o) {
                            ...
                            tR([], [e], function(e) {
                                ...
                                u[t].B[n - 1] = r),
                                tR([], s, function(r) {
                                    if (r = tH(i, [r[0], null].concat(r.slice(1)), null, a, o),
                                    void 0 === u[t].B ? (r.ea = n - 1,
                                    u[t] = r) : u[t].B[n - 1] = r,
                                    e.i.oa)
                                        for (let n of e.i.oa)
                        ...
                        _embind_register_class_constructor: function(e, t, n, r, i, a) {
                            ...
                            tR([], [e], function(e) {
                                ...
                                if (void 0 === e.i.$ && (e.i.$ = []),
                                void 0 !== e.i.$[t - 1])
                                    throw new e3(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${e.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                                return e.i.$[t - 1] = () => {
                                    t$(`Cannot construct ${e.name} due to unbound types`, o)
                                }
                                ,
                                tR([], o, function(r) {
                        ...
                        _embind_register_class_function: function(e, t, n, r, i, a, o, s) {
                            ...
                            tR([], [e], function(e) {
                                ...
                                var l = e.i.N
                                  , c = l[t];
                                return void 0 === c || void 0 === c.B && c.className !== e.name && c.ea === n - 2 ? (r.ea = n - 2,
                                r.className = e.name,
                                l[t] = r) : (tI(l, t, i),
                                l[t].B[n - 2] = r),
                                tR([], u, function(r) {
                                    return r = tH(i, r, e, a, o),
                                    void 0 === l[t].B ? (r.ea = n - 2,
                                    l[t] = r) : l[t].B[n - 2] = r,
                                    []
                                }),
                                []
                        ...
                        _embind_register_class_property: function(e, t, n, r, i, a, o, s, u, l) {
                            ...
                            tR([], [e], function(e) {
                                ...
                                var r = `${e.name}.${t}`
                                  , c = {
                                    get() {
                                        t$(`Cannot access ${r} due to unbound types`, [n, o])
                                    },
                                    enumerable: !0,
                                    configurable: !0
                                };
                        ...
                        _embind_register_enum: function(e, t, n, r) {
                            ...
                            tM(e, {
                                ...
                                readValueFromPointer: function(e, t, n) {
                                    ...
                                    case 2:
                                        return function(e) {
                                            return this.fromWireType((n ? k : F)[e >> 2])
                                        }
                                        ;
                                    default:
                        ...
                        _embind_register_function: function(e, t, n, r, i, a) {
                            ...
                            tR([], o, function(n) {
                                return tD(e, tH(e, [n[0], null].concat(n.slice(1)), null, i, a), t - 1),
                                []
                            })
                        },
                        ...
                        _embind_register_std_string: function(e, t) {
                            ...
                            tM(e, {
                                ...
                                toWireType: function(e, t) {
                                    ...
                                    r || t instanceof Uint8Array || t instanceof Uint8ClampedArray || t instanceof Int8Array || e5("Cannot pass non-string to std::string");
                                    ...
                                    n && r)
                                        ...
                                        for (r = 0; r < i; ++r) {
                                            ...
                                            255 < s && (nu(o),
                                            e5("String has UTF-16 code units that do not fit in 8 bits")),
                                            T[o + r] = s
                                        }
                                    else
                                        for (r = 0; r < i; ++r)
                                            T[o + r] = t[r];
                                    return null !== e && e.push(nu, a),
                                    a
                                },
                                argPackAdvance: 8,
                                readValueFromPointer: t_,
                        ...
                        _embind_register_std_wstring: function(e, t, n) {
                            ...
                            tM(e, {
                                name: n,
                                fromWireType: function(e) {
                                    for (var n, i = F[e >> 2], a = o(), u = e + 4, l = 0; l <= i; ++l) {
                                        var c = e + 4 + l * t;
                                        (l == i || 0 == a[c >> s]) && (u = r(u, c - u),
                                        void 0 === n ? n = u : n += "\0" + u,
                                        u = c + t)
                                    }
                                    return nu(e),
                                ...
                                toWireType: function(e, r) {
                                    "string" != typeof r && e5(`Cannot pass non-string to C++ string type ${n}`);
                                    var o = a(r)
                                      , u = nl(4 + o + t);
                                    return F[u >> 2] = o >> s,
                                    i(r, u + 4, o + t),
                        ...
                        _emval_get_method_caller: function(e, t) {
                            var n, r, i = function(e, t) {
                                for (var n = Array(e), r = 0; r < e; ++r)
                                    n[r] = tc(F[t + 4 * r >> 2], "parameter " + r);
                                return n
                            }(e, t), a = i[0], o = t5[t = a.name + "_$" + i.slice(1).map(function(e) {
                                return e.name
                            }).join("_") + "$"];
                            if (void 0 !== o)
                                return o;
                            ...
                            return n = (t, n, r, o) => {
                                ...
                                for (l = 0,
                                t = t[n].apply(t, s); l < e - 1; ++l)
                                    i[l + 1].Nb && i[l + 1].Nb(s[l]);
                                if (!a.fc)
                                    return a.toWireType(r, t)
                            }
                            ,
                            r = t3.length,
                            t3.push(n),
                        ...
                        _emval_take_value: function(e, t) {
                            return e9(e = (e = tc(e, "_emval_take_value")).readValueFromPointer(t))
                        },
                        abort: () => {
                            H("")
                        }
                        ...
                        emscripten_resize_heap: e => {
                            ...
                            for (var n = 1; 4 >= n; n *= 2) {
                                ...
                                r = Math.max(e, r);
                                e: {
                                    i = i.min.call(i, 2147483648, r + (65536 - r % 65536) % 65536) - E.buffer.byteLength + 65535 >>> 16;
                                    try {
                                        E.grow(i),
                                        j();
                                        var a = 1;
                        ...
                        environ_get: (e, t) => {
                            var n = 0;
                            return t7().forEach(function(r, i) {
                                var a = t + n;
                                for (i = F[e + 4 * i >> 2] = a,
                                a = 0; a < r.length; ++a)
                    ...
                    !function() {
                        function t(t) {
                            if (E = (M = t = t.exports).memory,
                            j(),
                            D = M.__indirect_function_table,
                            U.unshift(M.__wasm_call_ctors),
                            V--,
                            e.monitorRunDependencies && e.monitorRunDependencies(V),
                            0 == V && (null !== N && (clearInterval(N),
                            N = null),
                            $)) {
                                var n = $;
                                $ = null,
                        ...
                        ,
                        r = q,
                        R || "function" != typeof WebAssembly.instantiateStreaming || z(r) || r.startsWith("file://") || "function" != typeof fetch ? G(r, i, n) : fetch(r, {
                            credentials: "same-origin"
                    ...
                    var nu = e => (nu = M.free)(e)
                      , nl = e => (nl = M.malloc)(e)
                      , nc = e._ma_device__on_notification_unlocked = t => (nc = e._ma_device__on_notification_unlocked = M.ma_device__on_notification_unlocked)(t);
                    e._ma_malloc_emscripten = (t, n) => (e._ma_malloc_emscripten = M.ma_malloc_emscripten)(t, n),
                    e._ma_free_emscripten = (t, n) => (e._ma_free_emscripten = M.ma_free_emscripten)(t, n);
                    var nh = e._ma_device_process_pcm_frames_capture__webaudio = (t, n, r) => (nh = e._ma_device_process_pcm_frames_capture__webaudio = M.ma_device_process_pcm_frames_capture__webaudio)(t, n, r)
                      , nd = e._ma_device_process_pcm_frames_playback__webaudio = (t, n, r) => (nd = e._ma_device_process_pcm_frames_playback__webaudio = M.ma_device_process_pcm_frames_playback__webaudio)(t, n, r)
                      , nf = () => (nf = M.__errno_location)()
                      , np = e => (np = M.__getTypeName)(e);
                    function nv() {
                        function t() {
                            if (!d && (d = !0,
                            e.calledRun = !0,
                            !x)) {
                                if (e.noFSInit || eb || (eb = !0,
                                eJ(),
                                e.stdin = e.stdin,
                                e.stdout = e.stdout,
                                e.stderr = e.stderr,
                                e.stdin ? eK("stdin", e.stdin) : eY("/dev/tty", "/dev/stdin"),
                                e.stdout ? eK("stdout", null, e.stdout) : eY("/dev/tty", "/dev/stdout"),
                                e.stderr ? eK("stderr", null, e.stderr) : eY("/dev/tty1", "/dev/stderr"),
                                eG("/dev/stdin", 0),
                                eG("/dev/stdout", 1),
                                eG("/dev/stderr", 1)),
                                eP = !1,
                        ...
                        if (!(0 < V)) {
                            ...
                            Q(B),
                            0 < V || (e.setStatus ? (e.setStatus("Running..."),
                            setTimeout(function() {
                                setTimeout(function() {
                                    e.setStatus("")
                                }, 1),
                    ...
                    if (e.__embind_initialize_bindings = () => (e.__embind_initialize_bindings = M._embind_initialize_bindings)(),
                    e.dynCall_iiji = (t, n, r, i, a) => (e.dynCall_iiji = M.dynCall_iiji)(t, n, r, i, a),
                    e.dynCall_jiji = (t, n, r, i, a) => (e.dynCall_jiji = M.dynCall_jiji)(t, n, r, i, a),
                    e.dynCall_iiiji = (t, n, r, i, a, o) => (e.dynCall_iiiji = M.dynCall_iiiji)(t, n, r, i, a, o),
                    e.dynCall_iij = (t, n, r, i) => (e.dynCall_iij = M.dynCall_iij)(t, n, r, i),
                    e.dynCall_jii = (t, n, r) => (e.dynCall_jii = M.dynCall_jii)(t, n, r),
                    e.dynCall_viijii = (t, n, r, i, a, o, s) => (e.dynCall_viijii = M.dynCall_viijii)(t, n, r, i, a, o, s),
                    e.dynCall_iiiiij = (t, n, r, i, a, o, s) => (e.dynCall_iiiiij = M.dynCall_iiiiij)(t, n, r, i, a, o, s),
                    e.dynCall_iiiiijj = (t, n, r, i, a, o, s, u, l) => (e.dynCall_iiiiijj = M.dynCall_iiiiijj)(t, n, r, i, a, o, s, u, l),
                    e.dynCall_iiiiiijj = (t, n, r, i, a, o, s, u, l, c) => (e.dynCall_iiiiiijj = M.dynCall_iiiiiijj)(t, n, r, i, a, o, s, u, l, c),
                    $ = function e() {
                        d || nv(),
                        d || ($ = e)
                    }
                ...
                var r = void 0
                  ...
                  , a = function(e) {
                    var t = e.canvas
                      ...
                      , p = void 0 === f ? 1 : f;
                    if (!t || !o.length || !s || !u || !n || "undefined" == typeof window)
                        return null;
                    var v = null
                      , m = !1
                      , b = (function(e) {
                        ...
                        m = d && "touchend" === e.type && "touchstart" === v,
                        v = e.type;
                    ...
                    return t.addEventListener("mouseover", b),
            ...
            function ei(e) {
                ...
                return en[e](n, n.exports, ei),
                n.exports
            }
            ei.d = (e, t) => {
                for (var n in t)
                    ei.o(t, n) && !ei.o(e, n) && Object.defineProperty(e, n, {
                        enumerable: !0,
                        get: t[n]
                    })
            }
            ...
            _ = function() {
                function n(n) {
                    var r, i, a, o, s, u, l;
                    this.fit = null !== (r = null == n ? void 0 : n.fit) && void 0 !== r ? r : e.Contain,
                    this.alignment = null !== (i = null == n ? void 0 : n.alignment) && void 0 !== i ? i : t.Center,
                    this.layoutScaleFactor = null !== (a = null == n ? void 0 : n.layoutScaleFactor) && void 0 !== a ? a : 1,
                    this.minX = null !== (o = null == n ? void 0 : n.minX) && void 0 !== o ? o : 0,
                    this.minY = null !== (s = null == n ? void 0 : n.minY) && void 0 !== s ? s : 0,
                    this.maxX = null !== (u = null == n ? void 0 : n.maxX) && void 0 !== u ? u : 0,
                    this.maxY = null !== (l = null == n ? void 0 : n.maxY) && void 0 !== l ? l : 0
                }
            ...
            C = function() {
                ...
                return e.loadRuntime = function() {
                    u.default({
                        ...
                        e.wasmURL.toLowerCase() !== r ? (console.warn("Failed to load WASM from ".concat(e.wasmURL, " (").concat(n.message, "), trying jsdelivr as a backup")),
                        e.setWasmUrl(r),
                        e.loadRuntime()) : console.error(["Could not load Rive WASM file from ".concat(e.wasmURL, " or ").concat(r, "."), "Possible reasons:", "- Network connection is down", "- WebAssembly is not supported in this environment", "- The WASM file is corrupted or incompatible", "\nError details:", "- Type: ".concat(n.type), "- Message: ".concat(n.message), "- WebAssembly-specific error: ".concat(n.wasmError), "\nTo resolve, you may need to:", "1. Check your network connection", "2. Set a new WASM source via RuntimeLoader.setWasmUrl()", "3. Call RuntimeLoader.loadRuntime() again"].join("\n"))
                    })
                }
                ,
                ...
                e.isLoading = !1,
                e.callBackQueue = [],
                e.wasmURL = "https://unpkg.com/".concat(l.name, "@").concat(l.version, "/rive.wasm"),
                e
            }(),
            (A = n || (n = {}))[A.Number = 56] = "Number",
            ...
            M = function() {
                ...
                e.prototype.mapRuntimeInput = function(e, t) {
                    return e.type === t.SMIInput.bool ? new R(n.Boolean,e.asBool()) : e.type === t.SMIInput.number ? new R(n.Number,e.asNumber()) : e.type === t.SMIInput.trigger ? new R(n.Trigger,e.asTrigger()) : void 0
                }
                ,
                e.prototype.cleanup = function() {
                        ...
                        for (var r = this.animations.map(function(e) {
                            ...
                            if (s >= 0 || u >= 0)
                                ...
                                if (l) {
                                    ...
                                    if (d) {
                                        var f = new M(d,this.runtime,t,this.artboard);
            ...
            T.AudioStatusChange = "audiostatuschange",
            (I = a || (a = {})).OneShot = "oneshot",
            I.Loop = "loop",
            I.PingPong = "pingpong",
            L = function() {
                function e(e) {
            ...
            (F = o || (o = {}))[F.AVAILABLE = 0] = "AVAILABLE",
            F[F.UNAVAILABLE = 1] = "UNAVAILABLE",
            S = new (function(e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                    return t._started = !1,
                ...
                t.prototype.testAudio = function() {
                    return v(this, void 0, void 0, function() {
                        return m(this, function(e) {
                            switch (e.label) {
                            case 0:
                                if (!(this._status === o.UNAVAILABLE && null !== this._audioContext))
                                    return [3, 4];
                                e.label = 1;
                            case 1:
                ...
                Object.defineProperty(t.prototype, "systemVolume", {
                    get: function() {
                        return this._status === o.UNAVAILABLE ? (this.testAudio(),
                        0) : 1
                    },
                    enumerable: !1,
                    configurable: !0
            ...
            B = function() {
                function t(e) {
                    ...
                    e.canvas.constructor === HTMLCanvasElement && (this._observed = j.add(this.canvas, this.onCanvasResize)),
                    this.src = e.src,
                    this.buffer = e.buffer,
                    this.riveFile = e.riveFile,
                    this.layout = null !== (t = e.layout) && void 0 !== t ? t : new _,
                    ...
                    e.assetLoader && (this.assetLoader = e.assetLoader),
                    this.taskQueue = new k(this.eventManager),
                    this.init({
                        src: this.src,
                        buffer: this.buffer,
                ...
                t.prototype.init = function(e) {
                    ...
                    if (!this.destroyed) {
                        ...
                        this.loaded = !1,
                        this.readyForPlaying = !1,
                        C.awaitInstance().then(function(e) {
                            ...
                            n.initData(u, v, m, c, p).then(function() {
                ...
                t.prototype.initializeAudio = function() {
                    var e, t = this;
                    S.status == o.UNAVAILABLE && (null === (e = this.artboard) || void 0 === e ? void 0 : e.hasAudio) && null === this._audioEventListener && (this._audioEventListener = {
                        type: i.AudioStatusChange,
                        callback: function() {
                            return t.onSystemAudioChanged()
                        }
                    },
                    S.add(this._audioEventListener),
                    S.establishAudio())
                }
                ,
                ...
                t.prototype.initData = function(e, n, r, a, o) {
                    return v(this, void 0, void 0, function() {
                        ...
                        return m(this, function(l) {
                            ...
                            case 2:
                                if (!this.riveFile)
                                    throw new g(t.cleanupErrorMessage);
                ...
                t.prototype.initArtboard = function(e, t, n, r, a) {
                    if (this.file) {
                        ...
                        if (this.artboard = s,
                        s.volume = this._volume * S.systemVolume,
                        ...
                        if (this.animator = new P(this.runtime,this.artboard,this.eventManager),
                ...
                t.prototype.drawFrame = function() {
                    var e, t;
                    (null === (e = null == document ? void 0 : document.timeline) || void 0 === e ? void 0 : e.currentTime) ? this.loaded && this.artboard && !this.frameRequestId && (this._boundDraw(document.timeline.currentTime),
                ...
                t.prototype.draw = function(e, t) {
                    ...
                    for (this.frameTimes.push(C),
                    this.durations.push(C - a); this.frameTimes[0] <= C - 1e3; )
                ...
                t.prototype.cleanup = function() {
                    ...
                    null !== this._observed && j.remove(this._observed),
                    this.removeRiveListeners(),
                    this.file && (null === (e = this.riveFile) || void 0 === e || e.cleanup(),
                    this.file = null),
                    this.riveFile = null,
                    this.deleteRiveRenderer(),
                    null !== this._audioEventListener && (S.remove(this._audioEventListener),
                    this._audioEventListener = null),
                ...
                t.prototype.reset = function(e) {
                    var t, n, r = null == e ? void 0 : e.artboard, i = K(null == e ? void 0 : e.animations), a = K(null == e ? void 0 : e.stateMachines), o = null !== (t = null == e ? void 0 : e.autoplay) && void 0 !== t && t, s = null !== (n = null == e ? void 0 : e.autoBind) && void 0 !== n && n;
                    this.cleanupInstances(),
                ...
                Object.defineProperty(t.prototype, "volume", {
                    ...
                    set: function(e) {
                        this._volume = e,
                        this.artboard && (this.artboard.volume = e * S.systemVolume)
                    },
                    enumerable: !1,
                    configurable: !0
                }),
            ...
            N = function() {
                ...
                e.prototype.propertyFromPathSegments = function(e, t, n) {
                    if (t < e.length - 1) {
                        var r, i, a, o, u, l, c, h, d, f, p, v, m = this.internalViewModelInstance(e[t]);
                        return null !== m ? m.propertyFromPathSegments(e, t + 1, n) : null
                    }
                    var b = null;
                    switch (n) {
                    case s.Number:
                        if (null !== (b = null !== (i = null === (r = this._runtimeInstance) || void 0 === r ? void 0 : r.number(e[t])) && void 0 !== i ? i : null))
                            return new z(b,this);
                        break;
                    case s.String:
                        if (null !== (b = null !== (o = null === (a = this._runtimeInstance) || void 0 === a ? void 0 : a.string(e[t])) && void 0 !== o ? o : null))
                            return new H(b,this);
                        break;
                    case s.Boolean:
                        if (null !== (b = null !== (l = null === (u = this._runtimeInstance) || void 0 === u ? void 0 : u.boolean(e[t])) && void 0 !== l ? l : null))
                            return new Y(b,this);
                        break;
                    case s.Color:
                        if (null !== (b = null !== (h = null === (c = this._runtimeInstance) || void 0 === c ? void 0 : c.color(e[t])) && void 0 !== h ? h : null))
                            return new q(b,this);
                        break;
                    case s.Trigger:
                        if (null !== (b = null !== (f = null === (d = this._runtimeInstance) || void 0 === d ? void 0 : d.trigger(e[t])) && void 0 !== f ? f : null))
                            return new X(b,this);
                        break;
                    case s.Enum:
                        if (null !== (b = null !== (v = null === (p = this._runtimeInstance) || void 0 === p ? void 0 : p.enum(e[t])) && void 0 !== v ? v : null))
                            return new G(b,this)
                    }
                    return null
                }
                ...
                e.prototype.internalViewModelInstance = function(t) {
                    ...
                    if (null !== r) {
                        var i = new e(r,this);
                        return i.internalIncrementReferenceCount(),
            ...
            Q = function(e) {
                return new Promise(function(t) {
                    return C.getInstance(function(n) {
                        n.decodeAudio(e, t)
                    })
                }
                )
    ...
    60388: function(e, t, n) {
        ...
        function m(e) {
            var t, n, i, a, o, s, l, c = e.riveLoaded, p = void 0 !== c && c, m = e.canvasElem, b = e.containerRef, g = e.options, y = e.onCanvasHasResized, w = e.artboardBounds, _ = v(void 0 === g ? {} : g), C = r.useState({
                height: 0,
                width: 0
            }), A = C[0], R = A.height, E = A.width, M = C[1], P = r.useState({
                height: 0,
                width: 0
            }), T = P[0], I = T.height, L = T.width, k = P[1], F = r.useState(!0), S = F[0], O = F[1], x = _.fitCanvasToArtboardHeight, j = _.shouldResizeCanvasToContainer, D = _.useDevicePixelRatio, B = _.customDevicePixelRatio, U = (void 0 === (t = j) && (t = !0),
            i = (n = r.useState({
                width: 0,
                height: 0
            }))[0],
            ...
            r.useEffect(function() {
                ...
                if (t) {
                    var n = b.current;
                    return b.current && d && e.observe(b.current),
                    function() {
                        e.disconnect(),
                        n && d && e.unobserve(n)
                    }
            ...
            i), W = u(B), V = null != w ? w : {}, N = V.maxX, $ = V.maxY, H = r.useCallback(function() {
                var e, t, n, r, i = null !== (t = null === (e = b.current) || void 0 === e ? void 0 : e.clientWidth) && void 0 !== t ? t : 0, a = null !== (r = null === (n = b.current) || void 0 === n ? void 0 : n.clientHeight) && void 0 !== r ? r : 0;
                return x && w ? {
                    width: i,
            ...
            }, [m, b, U, W, H, S, O, I, L, R, E, y, j, x, D, p]),
            r.useEffect(function() {
                k({
                    width: 0,
                    height: 0
        ...
        var b, g = function() {
            ...
            ,
            e
        }(), y = globalThis.IntersectionObserver || g, w = function() {
            function e() {
                var e = this;
        ...
        function A(e, t) {
            ...
            var n = r.useState(null)
              ...
              , g = r.useCallback(function() {
                if (d) {
                    if (d.layout && d.layout.fit === i.Fit.Layout && s) {
                        var e = b * d.layout.layoutScaleFactor;
                        d.devicePixelRatioUsed = b,
                        d.artboardWidth = (null == s ? void 0 : s.width) / e,
                        d.artboardHeight = (null == s ? void 0 : s.height) / e
                    }
                    d.startRendering(),
                    d.resizeToCanvas()
                }
            ...
            r.useEffect(function() {
                var e, t = !1, n = function() {
                    if (s && t) {
                        ...
                        e.width > 0 && e.height > 0 && e.top < (window.innerHeight || document.documentElement.clientHeight) && e.bottom > 0 && e.left < (window.innerWidth || document.documentElement.clientWidth) && e.right > 0 && (null == d || d.startRendering(),
                        t = !1)
                    }
                };
                return s && !1 !== p.shouldUseIntersectionObserver && R(s, function(r) {
                    r.isIntersecting ? d && d.startRendering() : d && d.stopRendering(),
                    t = !r.isIntersecting,
                    clearTimeout(e),
            ...
            }, [R, E, d, s, p.shouldUseIntersectionObserver]),
            r.useEffect(function() {
                return function() {
                    d && (d.cleanup(),
                    f(null))
            ...
            r.useEffect(function() {
                d && M && (d.isPlaying ? (d.stop(d.animationNames),
                d.play(M)) : d.isPaused && (d.stop(d.animationNames),
                d.pause(M)))
            }, [M, d]);
            var P = r.useCallback(function(e) {
                return a.default.createElement(C, o({
                    setContainerRef: w,
                    setCanvasRef: y
                }, e))
            }, [y, w]);
        ...
        t.default = function(e) {
            var t = e.src
              ...
              , h = e.shouldResizeCanvasToContainer
              , d = e.automaticallyHandleEvents
              , f = e.children
              , p = s(e, ["src", "artboard", "animations", "stateMachines", "layout", "useOffscreenRenderer", "shouldDisableRiveListeners", "shouldResizeCanvasToContainer", "automaticallyHandleEvents", "children"])
              , v = A({
                src: t,
                artboard: n,
                animations: r,
                ...
                shouldResizeCanvasToContainer: void 0 === h || h
            }).RiveComponent;
            return a.default.createElement(v, o({}, p), f)
        }
        ,
        t.useResizeCanvas = m,
        t.useRive = A,
        ...
        t.useStateMachineInput = function(e, t, n, a) {
            ...
            return r.useEffect(function() {
                ...
                r(),
                e && e.on(i.EventType.Load, function() {
                    r()
                })
            }, [e]),
            s
